...
class livesay_gquote_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'lvsy-get-quote',
      VTHEME_NAME_P . __( ': Get a Quote', 'livesay' ),
      array(
        'classname'   => 'lvsy-get-quote',
        'description' => VTHEME_NAME_P . __( ' widget that displays get a quote.', 'livesay' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $target_field = array(
      ...
      'title' => __( 'Open New Window?', 'livesay' ),
    );
...
function livesay_gquote_widget_function() {
  register_widget( "livesay_gquote_widget" );
}
add_action( 'widgets_init', 'livesay_gquote_widget_function' );
