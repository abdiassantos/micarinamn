...
class livesay_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'lvsy-navigation-widget',
      VTHEME_NAME_P . __( ': Navigation', 'livesay' ),
      array(
        'classname'   => 'lvsy-navigation-widget',
        'description' => VTHEME_NAME_P . __( ' widget that displays navigations list.', 'livesay' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => __( 'Select Menu List :', 'livesay' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => __( 'Display Menu Children :', 'livesay' ),
      'help' => __( 'This only shows first level of child menus.', 'livesay' ),
    );
  ...
  public function widget( $args, $instance ) {
    ...
    $nav_menu_args = array(
      ...
      'menu'        => $nav_list,
      'depth'       => $nav_child,
      'items_wrap'  => '<ul id="%1$s" class="%2$s lvsy-sidenav">%3$s</ul>',
    );
...
function livesay_navigation_widget_function() {
  register_widget( "livesay_navigation_widget" );
}
add_action( 'widgets_init', 'livesay_navigation_widget_function' );
