...
// Custom Changes
if ( $overlay_dotted === 'true' || $overlay_color ) {
	$overlay_bg = $overlay_color;
	$overlay_div = '<div class="lvsy-overlay-pattern" style="background-color:'. $overlay_bg .';"></div>';
} else {
	$overlay_bg = '';
	$overlay_div = '';
}
if ( $overlay_dotted === 'true' ) {
	$overlay_class = 'lvsy-have-dotted';
} else {
	$overlay_class = 'lvsy-dhav-dotted';
}
...
$output .= $overlay_div; // Custom Changes
