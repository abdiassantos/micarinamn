 ...
 */
require_once LIVESAY_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'livesay_register_required_plugins' );
 ...
 */
function livesay_register_required_plugins() {
	/*
    ...
    array(
	    'name'					=> 'Livesay Core',
	    'slug'     			=> 'livesay-core',
	    'source'				=> 'https://victorthemes.com/plugins/livesay-core.zip',
	    'required'			=> true,
	    'external_url'	=> 'http://victorthemes.com/wp-themes/livesay/',
    ),
    ...
    array(
	    ...
	    'slug'     			=> 'revslider',
	    'source'				=> 'https://victorthemes.com/plugins/revslider.zip',
	    'required'			=> true,
    ...
    array(
	    ...
	    'slug'     			=> 'js_composer',
	    'source'				=> 'https://victorthemes.com/plugins/js_composer.zip',
	    'required'			=> true,
