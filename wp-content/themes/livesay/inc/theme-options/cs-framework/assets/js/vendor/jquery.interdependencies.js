...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Livesay the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is lvsyd.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to lvsy condition, true show always, false hide always
         *
         */
