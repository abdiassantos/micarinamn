...
class CSFramework_Option_switcher extends CSFramework_Options {
  ...
  public function output() {
    ...
    $on_text = ( isset( $this->field['on_text'] ) ) ? $this->field['on_text'] : esc_html__( 'On', 'livesay' );
    $off_text = ( isset( $this->field['off_text'] ) ) ? $this->field['off_text'] : esc_html__( 'Off', 'livesay' );
